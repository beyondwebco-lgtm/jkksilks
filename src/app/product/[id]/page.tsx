...
export default function ProductDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-[#210209] text-[#FFF8E7] flex flex-col font-sans selection:bg-[#D4AF37] selection:text-[#210209]">
      ...
      {/* Top Header */}
      <header className="w-full border-b border-[#D4AF37]/20 bg-[#1A0106]/90 backdrop-blur-md sticky top-0 z-50 px-6 py-4 flex items-center justify-between">
        <button 
          onClick={() => router.back()} 
          className="flex items-center gap-2 text-[#D4AF37] hover:text-white transition-colors text-xs uppercase tracking-widest cursor-pointer"
        >
        ...
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="font-serif text-lg tracking-widest text-[#D4AF37] font-semibold">JKK SILKS</span>
        </Link>

        <span className="text-[#D4AF37]/80 text-xs uppercase tracking-widest font-medium">
          {product.category}
        </span>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="flex gap-3 overflow-x-auto pb-2 pt-1">
                {allImages.map((imgUrl, index) => (
                  <button
                    ...
                    className={`relative w-20 h-24 flex-shrink-0 rounded-sm overflow-hidden border-2 transition-all cursor-pointer bg-black/30 ${
          ...
          <div className="flex flex-col justify-between h-full space-y-8">
            <div className="space-y-6">
              ...
              {/* Category & Title */}
              <div>
                <span className="inline-block text-[#D4AF37]/70 text-xs uppercase tracking-[0.3em] font-semibold mb-2">
                  {product.category}
                </span>
                <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-[#D4AF37] leading-tight font-medium">
                  {product.name}
                </h1>
              </div>
              ...
              {(product.original_price || product.discount_price) && (
                <div className="p-4 bg-[#1A0106] border border-[#D4AF37]/30 rounded-sm inline-block w-full">
                  <div className="flex items-baseline gap-3 flex-wrap">
                    ...
                    {discountPercent && (
                      <span className="text-[#E57373] text-base sm:text-lg font-bold italic ml-2">
                        {discountPercent}% OFF
                      </span>
                    )}
                  </div>
                  <p className="text-[#D4AF37]/50 text-[11px] uppercase tracking-wider mt-1">
              ...
              {product.description && (
                <div className="space-y-2 pt-2">
                  ...
                  <p className="text-[#FFF8E7]/80 text-sm leading-relaxed whitespace-pre-line">
                    {product.description}
                  </p>
                </div>
              )}
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-[#D4AF37]/20">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs text-[#D4AF37]/80 font-medium">100% Authentic Handloom</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="p-2 rounded-full border border-[#D4AF37]/30 bg-[#D4AF37]/5 text-[#D4AF37]">
                    <Truck className="w-4 h-4" />
                  </div>
                  <span className="text-xs text-[#D4AF37]/80 font-medium">Safe & Insured Shipping</span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-[#D4AF37]/20 space-y-3">
              <button
                ...
                className="w-full py-4 bg-[#D4AF37] hover:bg-[#c49f2e] text-[#210209] font-bold text-sm uppercase tracking-[0.2em] rounded-sm transition-all duration-300 flex items-center justify-center gap-3 shadow-[0_0_25px_rgba(212,175,55,0.25)] hover:shadow-[0_0_35px_rgba(212,175,55,0.4)] cursor-pointer"
              >
