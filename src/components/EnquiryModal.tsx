...
`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
      <div 
        className="relative w-full max-w-xl bg-gradient-to-b from-[#1F0208] to-[#140004] border border-[#D4AF37]/40 rounded-lg p-5 sm:p-8 shadow-[0_0_50px_rgba(212,175,55,0.25)] text-[#FFF8E7] my-4 sm:my-8 max-h-[92vh] overflow-y-auto"
      >
        {/* Close Button */}
        <button
          onClick={handleResetAndClose}
          className="absolute top-3 right-3 sm:top-4 sm:right-4 p-2 text-[#D4AF37]/60 hover:text-[#D4AF37] transition-colors rounded-full hover:bg-[#D4AF37]/10 active:scale-95 cursor-pointer"
        ...
        {submitted ? (
          ...
          <div className="flex flex-col items-center text-center py-6 sm:py-8">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#D4AF37]/15 border border-[#D4AF37] flex items-center justify-center mb-4 sm:mb-5 text-[#D4AF37] shadow-[0_0_20px_rgba(212,175,55,0.3)]">
              <CheckCircle2 className="w-8 h-8 sm:w-9 sm:h-9" />
            </div>

            <h3 className="font-serif text-xl sm:text-2xl text-[#D4AF37] mb-2 tracking-wide">
              Enquiry Prepared
            </h3>
            
            <p className="text-xs sm:text-sm text-[#FFF8E7]/80 max-w-md leading-relaxed mb-6 font-light">
              Your formal enquiry has been prepared and addressed to <strong className="text-[#D4AF37] font-medium">{targetEmail}</strong>.
            </p>

            <div className="w-full bg-[#120004] border border-[#D4AF37]/20 rounded-md p-3.5 sm:p-4 mb-6 text-left text-xs space-y-1.5 sm:space-y-2 text-[#FFF8E7]/70">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white font-medium text-xs uppercase tracking-wider py-3.5 px-5 rounded-sm transition-all shadow-md active:scale-[0.98] cursor-pointer"
              >
              ...
              <button
                type="button"
                onClick={handleResetAndClose}
                className="flex-1 inline-flex items-center justify-center gap-2 border border-[#D4AF37]/40 hover:border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37]/10 font-medium text-xs uppercase tracking-wider py-3.5 px-5 rounded-sm transition-all active:scale-[0.98] cursor-pointer"
              >
                Done
              </button>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col items-center text-center mb-5 sm:mb-6">
              <div className="relative w-7 h-7 sm:w-8 sm:h-8 mb-2 opacity-90">
                <Image 
              ...
              <p className="text-xs text-[#FFF8E7]/60 tracking-wide mt-1 font-light max-w-sm">
                For custom orders, bridal appointments, and catalog consultations. Linked directly to <span className="text-[#D4AF37] break-all">{targetEmail}</span>.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#120004]/80 border border-[#D4AF37]/30 rounded-sm py-2.5 pl-9 pr-3 text-base sm:text-sm text-[#FFF8E7] placeholder-[#FFF8E7]/30 focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-all"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#120004] border border-[#D4AF37]/30 rounded-sm py-2.5 px-3 text-base sm:text-sm text-[#FFF8E7] focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-all"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  <textarea
                    ...
                    className="w-full bg-[#120004]/80 border border-[#D4AF37]/30 rounded-sm p-3 text-base sm:text-sm text-[#FFF8E7] placeholder-[#FFF8E7]/30 focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-all leading-relaxed"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                className="w-full mt-2 bg-[#D4AF37] hover:bg-[#E5C158] text-[#210209] font-semibold text-xs uppercase tracking-[0.2em] py-3.5 px-4 rounded-sm flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(212,175,55,0.25)] hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] active:scale-[0.98] cursor-pointer"
              >
